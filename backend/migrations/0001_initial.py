...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('phone', 'Телефон'), ('address', 'Адрес'), ('email', 'Email')], max_length=10, verbose_name='Тип контакта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='backend.product', verbose_name='Продукт')),
        ...
        migrations.AddIndex(
            model_name='order',
            index=models.Index(fields=['status', 'dt'], name='backend_ord_status_73e264_idx'),
        ),
        migrations.AddIndex(
            model_name='order',
            index=models.Index(fields=['user', 'dt'], name='backend_ord_user_id_2c54dc_idx'),
        ),
