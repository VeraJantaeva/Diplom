# Generated by Django 5.2.7 on 2025-12-08 05:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model",
                    models.CharField(
                        blank=True, max_length=80, verbose_name="Модель"
                    ),
                ),
                (
                    "external_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        blank=True, null=True, verbose_name="Ссылка"
                    ),
                ),
                (
                    "state",
        ...
        migrations.AddIndex(
            model_name="order",
            index=models.Index(
                fields=["status", "dt"], name="backend_ord_status_73e264_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="order",
            index=models.Index(
                fields=["user", "dt"], name="backend_ord_user_id_2c54dc_idx"
            ),
        ),
